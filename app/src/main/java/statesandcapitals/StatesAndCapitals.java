...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        testResults.put("A42", statesandcapitals.StatesAndCapitalsCheck.adv42(allStateAndCapitalNamesTogetherAsLists));
        ...
        testResults.put("A43", statesandcapitals.StatesAndCapitalsCheck.adv43(stateNameToCapitalNamesMap));
        ...
        testResults.put("E1", statesandcapitals.StatesAndCapitalsCheck.expert1(allDenonymsThatDoNotContainStateName));
        ...
        testResults.put("E2",
                statesandcapitals.StatesAndCapitalsCheck.expert2(totalNumberOfHonoluluSisterCitiesStartingWithCa));
